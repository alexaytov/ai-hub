...
public class AgentService {
    ...
    public AgentService(UserService userService, AgentRepository repository, ModelMapper mapper, SystemMessageRepository messageRepository, ModelRepository modelRepository) {
